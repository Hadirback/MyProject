...
namespace EmailSenderLib
{
    ...
    {
        private const String URL = "http://v.te.admin.slotlogic.eu/send_mail.php"; /*"https://v1.slotlogic.eu/send_mail.php";*/
        ...
        public static async Task<String> RequestSendingEmail(String base64Text)
        {
            ...
            String uid = "QHtzn0C2eS6Nlwgu"; //Service.GetLicenseUid();
